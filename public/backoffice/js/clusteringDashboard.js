...
(function (root, factory) {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".cdb-modal-close{display:flex;align-items:center;justify-content:center;flex-shrink:0;border:0;padding:0;background:#f0f0ee;color:#374151;width:32px;height:32px;border-radius:50%;font-size:1.25rem;line-height:1;cursor:pointer;transition:background 160ms ease,color 160ms ease;}",
      ".cdb-modal-close:hover{background:#e2e2df;color:#0d1117;}",
      ".cdb-modal-close:focus-visible{outline:2px solid #c41d38;outline-offset:2px;}",
