...
(function () {
  ...
  var EN = {
    ...
    "auth.adminSubtitle": "Access administration to manage teachers, classes and access.",
    "auth.adminEmail": "Administrator email",
    "auth.adminPwPh": "Your administrator password",
    ...
    "dash.aiPrediction": "Success indicator",
    "dash.ofSuccess": "success rate",
    "dash.analyzing": "Analyzing…",
    "dash.predDisclaimer": "An AI estimate based on your activity — this is not your final grade and may be inaccurate.",
    ...
    "dash.learningProfile": "Your learning profile",
    "dash.retakeVark": "Retake the test",
    "dash.discoverProfile": "Discover your learning profile",
    "dash.discoverProfileTip": "Answer a few questions to identify <b>how you learn best</b> — NextLearn will then tailor its advice to your style.",
    "dash.studyTip": "Study tip",
    "dash.mostAttentive": "Most focused on",
    "dash.revisionTitle": "Targeted revision",
    "dash.revisionHint": "Based on your estimated per-skill mastery",
    "dash.revisionBlocked": "Review first",
    "dash.contentVideo": "Video",
    "dash.contentReading": "Reading",
    "dash.contentQuiz": "Quiz",
    ...
    /* "Explain it in your own words" (NLP formative check) */
    "explain.title": "Explain it in your own words",
    "explain.badge": "Self-check",
    "explain.hint": "Write your own explanation of this lesson (a few sentences). The assistant compares your text with the course content and shows which notions you covered well and which ones to review.",
    "explain.placeholder": "In your own words, explain what you took away from this lesson...",
    "explain.submit": "Analyze my explanation",
    "explain.checking": "Analyzing...",
    "explain.tooShort": "Write at least a few sentences so the analysis is useful.",
    "explain.unavailable": "The analysis is not available for this lesson yet.",
    "explain.error": "Analysis unavailable right now. Try again in a moment.",
    "explain.bandAcquired": "Very good coverage of the lesson's notions",
    "explain.bandPartial": "Partial coverage — a few notions still to review",
    "explain.bandGap": "Several key notions are still missing from your explanation",
    "explain.coveredCount": "{n} of {total} notion(s) covered",
    "explain.toggle": "Collapse / expand",
    "explain.coveredIntro": "Well-covered notions",
    "explain.missingIntro": "Notions to review",
    "explain.degraded": "Approximate analysis (word matching) — the score may underestimate your explanation.",
    ...
    "bo.teacherListSub": "Each teacher and the number of classes assigned to them.",
    "bo.teacherEmail": "Teacher email",
    "bo.fullName": "Full name",
    "bo.phone": "Phone number",
    "bo.cancelEdit": "Cancel edit",
    "bo.classAdd": "Add a class",
    "bo.classAddSub": "Name the class and pick the teacher in charge of it.",
    "bo.className": "Class name",
    "bo.classCreate": "Create the class",
    "bo.classListTitle": "Existing classes",
    "bo.classListSub": "Open a class to manage its students.",
    "bo.calendarTitle": "Course schedule",
    "bo.calendarSub": "Set the start date: sub-skills then unlock week by week, for every class.",
    "bo.calendarGenerate": "Generate the global schedule",
    "bo.startDate": "Start date",
    "bo.accessRuleTitle": "Access rule per class",
    "bo.accessRuleSub": "Grant or block a module for a given class.",
    "bo.accessRule": "Access rule",
    "bo.accessGrant": "Grant access",
    "bo.accessBlock": "Block access",
    "bo.accessApply": "Apply the rule",
    "bo.accessTableTitle": "Class access by module",
    "bo.accessTableSub": "Schedule and permission status, class by class.",
    "bo.subAcquisUnlocked": "Sub-skills unlocked",
    "bo.grantedModules": "Granted modules",
    "bo.blockedModules": "Blocked modules",
    "bo.unlocked": "unlocked",
    "bo.next": "next",
    "bo.notSet": "Not set",
    "bo.noCalendar": "No schedule generated",
    "bo.noGranted": "No module granted",
    "bo.noBlocked": "No module blocked",
